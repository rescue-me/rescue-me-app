...
starWars = client.getDB("rescueme");

starWars.createCollection("users", {capped: false});
starWars.createCollection("shelters", {capped: false});
starWars.createCollection("dogs", {capped: false});

starWars.users.insertMany([
